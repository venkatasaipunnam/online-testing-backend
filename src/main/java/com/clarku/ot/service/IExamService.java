...
public interface IExamService {
	...
	Boolean createQuestion(CreateQuestionVO question, UserVO user) throws GlobalException;

	Boolean createOption(CreateOptionVO option, UserVO user) throws GlobalException;
